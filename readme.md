...
> **[Cite / DOI (Zenodo): 10.5281/zenodo.22964117](https://doi.org/10.5281/zenodo.22964117)** · **[Research paper (PDF)](docs/PAPER.md)** · **Author: Brutchsama Jean-Louis**
>
> This repository is the canonical code, data, and scripts for the paper. The Zenodo record [`10.5281/zenodo.22964117`](https://doi.org/10.5281/zenodo.22964117) is linked here and back: the paper's *Data and code availability* section cites this GitHub repository, and the Zenodo record's related-identifier field points to it.
